...
public:
    ...
    Material()
        : ambient(0.1f,0.1f,0.1f),
          ...
          kA(0.2), kD(0.8), shininess(32.0),
          specularStrength(0.0), roughness(1.0),
          reflection(0.0), IndexOfRefraction(0.0), transparency(0.0), absorption(Farbe(0,0,0)) {}

    // Konstruktor mit allen Parametern
Material(
    const Farbe& ambient,
    const Farbe& diffuse,
    const Farbe& specular,
    const Farbe& emission,
    double kA,
    double kD,
    double shininess,
    double specularStrength,
